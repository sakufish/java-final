...
public class CChenDistanceFighterRobot extends FighterRobot{

	private static final int ATTACK_VALUE = 3;
	private static final int DEFENCE_VALUE = 3;
	private static final int MOVE_VALUE = 4;	
	
	// Default value
	private int health = 100; 

	public CChenDistanceFighterRobot (City c, int a, int s, Direction d, int id, int maxHealth){
	...
	public TurnRequest takeTurn(int energy, OppData[] data) {
		int target = targetRobot(data, 1, 0);
