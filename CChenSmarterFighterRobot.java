...
/**
 * Its more defensive s it survives longer
 * 
 * fixed weighting errors and made more logical than lv3
 */
public class CChenSmarterFighterRobot extends FighterRobot{

	private static final int ATTACK_VALUE = 2;
	private static final int DEFENCE_VALUE = 6;
	...
	public CChenSmarterFighterRobot (City c, int a, int s, Direction d, int id, int maxHealth){
	...
	public TurnRequest takeTurn(int energy, OppData[] data) {
		...
		int target = this.targetRobot(data, 0.8, 0.2);
		...
		if (this.decision(positionVal, energy, 0.3, 0.2, 0.5) <= 0.3 && energy > 20) {
